...
#define S3C24X0_GetBase_MEMCTL()		((S3C24X0_MEMCTL 		* const)S3C24X0_MEMCTL_BASE)
#define S3C24X0_GetBase_USB_HOST()		((S3C24X0_USB_HOST 		* const)S3C24X0_USB_HOST_BASE)
#define S3C24X0_GetBase_INTERRUPT()		((S3C24X0_INTERRUPT		* const)S3C24X0_INTERRUPT_BASE)
#define S3C24X0_GetBase_DMAS()			((S3C24X0_DMAS			* const)S3C24X0_DMA_BASE)
#define S3C24X0_GetBase_CLOCK_POWER()	((S3C24X0_CLOCK_POWER	* const)S3C24X0_CLOCK_POWER_BASE)
#define S3C24X0_GetBase_LCD()			((S3C24X0_LCD			* const)S3C24X0_LCD_BASE)
#define S3C2410_GetBase_NAND()			((S3C2410_NAND			* const)S3C2410_NAND_BASE)
#define S3C2440_GetBase_NAND()			((S3C2440_NAND			* const)S3C2410_NAND_BASE)
#define S3C24X0_GetBase_UART(nr)		((S3C24X0_UART			* const)(S3C24X0_UART_BASE + (nr * 0x4000)))
#define S3C24X0_GetBase_TIMERS()		((S3C24X0_TIMERS		* const)S3C24X0_TIMER_BASE)
#define S3C24X0_GetBase_USB_DEVICE()	((S3C24X0_USB_DEVICE	* const)S3C24X0_USB_DEVICE_BASE)
#define S3C24X0_GetBase_WATCHDOG()		((S3C24X0_WATCHDOG		* const)S3C24X0_WATCHDOG_BASE)
#define S3C24X0_GetBase_I2C()			((S3C24X0_I2C			* const)S3C24X0_I2C_BASE)
#define S3C24X0_GetBase_I2S()			((S3C24X0_I2S			* const)S3C24X0_I2S_BASE)
#define S3C24X0_GetBase_GPIO()			((S3C24X0_GPIO			* const)S3C24X0_GPIO_BASE)
#define S3C24X0_GetBase_RTC()			((S3C24X0_RTC			* const)S3C24X0_RTC_BASE)
#define S3C2410_GetBase_ADC()			((S3C2410_ADC			* const)S3C2410_ADC_BASE)
#define S3C24X0_GetBase_SPI()			((S3C24X0_SPI			* const)S3C24X0_SPI_BASE)
#define S3C2410_GetBase_SDI()			((S3C2410_SDI			* const)S3C2410_SDI_BASE)
