...
#define LOGD(fmt,arg...) LOG("\033[38;2;" GREEN "m" fmt "\033[0m",##arg)
#define LOGW(fmt,arg...) LOG("\033[38;2;" YELLOW "m" fmt "\033[0m",##arg)
#define LOGE(fmt,arg...) LOG("\033[38;2;" RED "m" fmt "\033[0m",##arg)
#define LOGF(fmt,arg...) LOG("\033[38;2;" PURPLE "m" fmt "\033[0m",##arg)
