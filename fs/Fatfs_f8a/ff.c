...
WORD  LD_WORD(void *pt)        
{
      ...
      p_c_p=(BYTE *)(pt); 
      c_val_1=(WORD) (  ( (p_c_p[1])<<8  ) | (  p_c_p[0] ) ); 
      return c_val_1;
}

DWORD LD_DWORD(void *pt)       
{
      BYTE  *p_c_p;
      DWORD c_val_2;
      
      p_c_p=(BYTE *)(pt); 
      c_val_2=(DWORD)(  ( (p_c_p[3])<<24 ) | ( (p_c_p[2]<<16) ) | ( (p_c_p[1]<<8) ) | ( p_c_p[0] ) ); 
      return c_val_2;       
}
...
)
{
	...
	//{	return 0;}
	//if ( (LD_DWORD(&(fs->win[BS_FilSysType32]))&0x00FFFFFF) == 0x544146)
	//{	return 0;}
